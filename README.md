...
# Experiment with Markdown syntax

## Try out Markdown syntax yourself

Check description first on [this site](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet), then append your **own** Markdown styled text.
~~Do not click on any link you find in non trusted documents.~~


Task 5 edit on branch B !!!